...
PYBIND11_MODULE(Body, m)
{
    ...
    py::class_<JointPath, shared_ptr<JointPath>>(m, "JointPath")
        ...
        .def("calcJacobian", (Eigen::MatrixXd (JointPath::*)()const)&JointPath::calcJacobian)
        .def("calcJacobian", (void (JointPath::*)(Eigen::MatrixXd&)const)&JointPath::calcJacobian)
